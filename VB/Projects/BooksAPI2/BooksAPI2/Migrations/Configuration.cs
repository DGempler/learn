namespace BooksAPI2.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BooksAPI2.Models.BooksAPI2Context>
    {
        ...
        protected override void Seed(BooksAPI2.Models.BooksAPI2Context context)
        {
